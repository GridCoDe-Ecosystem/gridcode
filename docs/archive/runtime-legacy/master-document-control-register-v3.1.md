...
MDCR v3.1 defines: document authority hierarchy, tier classification, supersession rules, freeze boundaries, cross-document dependency map, and canonical folder taxonomy.

This document supersedes MDCR v3.0 and all previous Master Index versions. MDCR is the constitutional authority for documentation governance.

Changes from v3.0: added five new Tier-2 documents to Section 3 and Section 9; removed three phantom archive entries that were never instantiated.
...
Whitepaper is narrative binding. It cannot override Tier-1 spine. It must conform to identity, runtime, and vault invariants.
...
**Supersedes:** master-document-control-register-v3.0.md
**Requires:**
