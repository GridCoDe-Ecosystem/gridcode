...
MDCR v3.0 defines: document authority hierarchy, tier classification, supersession rules, freeze boundaries, cross-document dependency map, and canonical folder taxonomy.

This document supersedes all previous Master Index versions. MDCR is the constitutional authority for documentation governance.
...
```
docs/archive/
  master-index-v2.0.md
  deprecated-fsm-matrix-v1.0.md
  legacy-drafts/
```
...
**Supersedes:** master-document-index-v2.0.md, master-document-index-v2.1.md
**Requires:** tier-1-protocol-freeze-declaration-v1.0.md
